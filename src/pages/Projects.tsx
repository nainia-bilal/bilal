...
const projects = [
  ...
  },
  {
    ...
    description: 'An upcoming innovative project focused on solving real-world problems through cutting-edge web technologies.',
    url: '#',
